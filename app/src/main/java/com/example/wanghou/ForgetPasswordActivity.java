...
public class ForgetPasswordActivity extends AppCompatActivity implements View.OnClickListener {
            ...
            switch (msg.what) {
                ...
                case 2:
                    if ("OK".equals((String) msg.obj)) {
                        ...
                        //跳转登录界面
                    }else   Toast.makeText(getApplicationContext(),"网络延时请稍后",Toast.LENGTH_SHORT).show();
                    break;
            }
        }
    };
    ...
    public void init(){
        fanhui_7=(ImageButton)findViewById(R.id.fanhui_7);
        fanhui_7.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        ForgetPasswordGet_yanzhengpassword.setOnClickListener(this);
